...
Run `ng build --deploy-url /wp-content/themes/angularPress/dist/` to build the project. The build artifacts will be stored in the `dist/` directory. Use the `--prod` flag for a production build.
